...
the full details and more examples at the [Context Broker documentation](https://github.com/telefonicaid/fiware-orion/blob/master/doc/manuals/orion-api.md#subscriptions-operations).
